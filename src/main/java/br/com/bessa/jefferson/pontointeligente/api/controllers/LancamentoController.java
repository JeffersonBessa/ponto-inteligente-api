...
public class LancamentoController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody 
			LancamentoDto lancamentoDto, BindingResult result) throws ParseException {
	...
	/**
	 * Valida um funcionário verificando se ele é existe e se é válido no sistema.
	 * 
	 * @param lancamentoDto
	 * @param result
	 */
	...
	/**
	 * Retorna um LancamentoDto para uma entidade lancamento.
	 * 
	 * @param lancamentoDto
	 * @param result
	 * @return Lancamento
